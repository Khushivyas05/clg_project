...
<section class="w3l-bootstrap-header">
  <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
    <div class="container">
    <a class="navbar-brand" href="index.html"><span class="fa fa-truck"></span> Packers</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline">
        <a class="btn btn-secondary btn-theme" href="track-order-form.html"> Track Order </a>
      </form>
    </div>
  </div>
  </nav>
