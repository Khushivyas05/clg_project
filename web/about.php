	...
	<div class="calltoaction-20  py-5 editContent">
		<div class="container py-md-3">
			<div class="heading text-center mx-auto">
				...
				<p class="my-3 head">Transport services is amongst the most renowned and appreciated cargo service providers in the industry. We started our journey with the aim of delivering the logistics and transportation excellence to our customers ensuring their comfort as well as success.</p>
		...
		<div class="features py-5" id="features">
			...
			<div class="fea-gd-vv row mt-5 pt-3">
				<div class="feature-gd-left col-lg-4 pr-lg-5 pr-3">	
			        <h4>Our vision<h4>
					<h6> To stay ahead among our rivals in the transport and logistics industry by providing world-class and innovative moving solutions to our clients. We wish to become the top choice of our customers when they are looking for a reliable, affordable and professional transporter.</h6>
		...
		<div class="container py-md-3">
			<div class="team-61_sur-wrap">
				<div class="grid grid-column-2">
					<div class="heading text-center mx-auto">
						<!--<h3 class="head">Meet Our Experts</h3>
