        ...
        Q = function (h, c) {
            ...
            this.doRailClick = function (d, c, f) {
                ...
                b.locked ||
                    (b.cancelEvent(d),
                    c
                        ? ((c = f ? b.doScrollLeft : b.doScrollTop), (g = f ? (d.pageX - b.railh.offset().left - b.cursorwidth / 2) * b.scrollratio.x : (d.pageY - b.rail.offset().top - b.cursorheight / 2) * b.scrollratio.y), c(g))
                        : ((c = f ? b.doScrollLeftBy : b.doScrollBy), (g = f ? b.scroll.x : b.scroll.y), (d = f ? d.pageX - b.railh.offset().left : d.pageY - b.rail.offset().top), (f = f ? b.view.w : b.view.h), g >= d ? c(f) : c(-f)));
            };
                    ...
                    ? ((this.prepareTransition = function (d, c) {
                      ...
                      (this.doScrollPos = function (c, e, f) {
                          ...
                          b.timer = setTimeout(function () {
                              ...
                              0 < l &&
                                  (!b.scrollrunning && b.onscrollstart && b.onscrollstart.call(b, { type: "scrollstart", current: { x: k, y: f }, request: { x: c, y: e }, end: { x: b.newscrollx, y: b.newscrolly }, speed: l }),
                                  g.transitionend
